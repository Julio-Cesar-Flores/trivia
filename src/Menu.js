...
const Menu = () => {
  ...
  <div id="sel">
    ...
    <select id="trivia_category" class="w3-select w3-border">
    ...
    <select id="trivia_difficulty" class="w3-select w3-border">
    ...
    <select id="trivia_type" class="w3-select w3-border">
    ...
    <br>
    <br>
    <button id="bInicio" class="w3-btn w3-green">Iniciar</button>
  </div>

<div id="preg"></div>
<p id="msg"></p>
<div id="botones" style="display:none">
  <button id="bIni" class="w3-btn w3-red">Nueva Trivia</button>
  <span>____</span>
  <button id="bVer" class="w3-btn w3-black">Verificar</button>
<div>
<br/>
`;
};
